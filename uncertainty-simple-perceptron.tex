...
Where the $55 – 57\%$ baseline accuracy (Table IV) is consistent with industry benchmarks; The Renaissance Technologies Medallion Fund operated at a $$\approx 50.75\%$$ per-trade win rate \cite{b13}.
...
\bibitem{b13} G. Zuckerman, ``The Man Who Solved the Market: How Jim Simons Launched the Quant Revolution,'' Portfolio/Penguin, New York, NY, USA, 2019.
\end{thebibliography}
